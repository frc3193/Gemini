...
std::shared_ptr<Ultrasonic> RobotMap::axialTestUltrasonic;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=ALLOCATION
std::shared_ptr<ADXRS450_Gyro> RobotMap::gyroTest;
std::shared_ptr<Servo> RobotMap::legitServo;
std::shared_ptr<Encoder> RobotMap::encoderTest;
std::shared_ptr<BuiltInAccelerometer> RobotMap::bAccel;
...
void RobotMap::init() {
    ...
    axialTestUltrasonic.reset(new Ultrasonic(1, 2, Ultrasonic::DistanceUnit::kInches));
    lw->AddSensor("AxialTest", "Ultrasonic", axialTestUltrasonic);
    ...
    legitServo.reset(new Servo(4));
    encoderTest.reset(new Encoder(4, 5, false, Encoder::EncodingType::k4X));
    bAccel.reset(new BuiltInAccelerometer(Accelerometer::kRange_8G));
}
